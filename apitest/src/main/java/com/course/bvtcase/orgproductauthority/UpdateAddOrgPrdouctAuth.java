 ...
 * Create by qym on 2020/1/9 13:29
 * @author qym
 */
public class UpdateAddOrgPrdouctAuth {
    @BeforeMethod(
            description = "机构产品权限修改"
    )
    ...
    @Test(groups = "UpdateAddOrgPrdouctAuth",description = "机构产品权限修改")
    public void  updateAddOrgPrdouctAuth() throws URISyntaxException, IOException, InterruptedException {
        Thread.sleep(100);
