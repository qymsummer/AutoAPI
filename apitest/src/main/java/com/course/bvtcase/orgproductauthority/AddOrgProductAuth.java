 ...
 */
public class AddOrgProductAuth {
    @BeforeMethod(
            description = "机构产品权限添加"
    )
    ...
    @Test(groups = "AddOrgProductAuth",description = "机构产品权限添加")
    public void  addOrgProductAuth() throws URISyntaxException, IOException, InterruptedException {
        Thread.sleep(100);
        ...
        builder.addParameter("platformIds","0,1,2,3,4,5,6,7,8");
