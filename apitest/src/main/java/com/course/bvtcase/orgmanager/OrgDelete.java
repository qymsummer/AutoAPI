...
public class OrgDelete {
    ...
    @Test(groups = "OrgDelete", description = "删除机构")
    public void orgDelete() throws IOException, InterruptedException, URISyntaxException {
        Thread.sleep(100);
        URIBuilder builder = new URIBuilder(TestConfig.deleteOrg);
        System.out.println(builder);
        String menuId = TokenFile.readFile("E:\\Data\\OrgID.txt");
        String newMenuId = menuId.replaceAll("[\\t\\n\\r\\s]", "");
        builder.addParameter("orgId", newMenuId);
