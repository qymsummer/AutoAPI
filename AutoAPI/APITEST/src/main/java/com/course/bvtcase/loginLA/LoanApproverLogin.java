...
public class LoanApproverLogin {
    private static String account = "ABC334563";
    private static String password = "ABC334563";
    ...
    @Test(groups = "LoanApproverloginCase", dependsOnGroups = "loginOut",description = "用户登录成功")
    public void loginCaseLA() throws Exception {
